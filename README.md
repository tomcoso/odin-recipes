# odin-recipes
The Odin Project. HTML Basics. Recipe website

In this project I will practice what I have learned about basic HTML and Git

The project in case is a basic website (only HTML) that contains links to recipes of my choosing
